...
<div id="carouselSlider" class="carousel slide mb-5" data-bs-ride="carousel" data-bs-interval="2000">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo e(asset('storage/slider/1.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 1">
    </div>
    <div class="carousel-item">
      <img src="<?php echo e(asset('storage/slider/2.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 2">
    </div>
    <div class="carousel-item">
      <img src="<?php echo e(asset('storage/slider/3.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 3">
    </div>
        <div class="carousel-item active">
      <img src="<?php echo e(asset('storage/slider/4.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 4">
    </div>
    <div class="carousel-item">
      <img src="<?php echo e(asset('storage/slider/5.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 5">
    </div>
    <div class="carousel-item">
      <img src="<?php echo e(asset('storage/slider/6.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 6">
    </div>
        <div class="carousel-item">
      <img src="<?php echo e(asset('storage/slider/7.jpg')); ?>" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Slider 7">
    </div>
                ...
                <div class="card mb-3 shadow-sm border-0">
                    <div class="row g-0 align-items-center">
                        <div class="col-md-4 px-2 py-2">
                            <img src="<?php echo e(asset('storage/' . $item->gambar_berita)); ?>"
                        ...
                        <div class="col-md-8">
                            <div class="card-body py-2 pe-3">
                                <h6 class="card-title fw-bold mb-1">
                                    <?php echo e(\Illuminate\Support\Str::limit($item->judul_berita, 60)); ?>

                                </h6>
                                <p class="card-text mb-1 small text-muted">
                                    <?php echo \Illuminate\Support\Str::limit(strip_tags($item->isi_berita), 80); ?>

                                </p>
                                <small class="text-muted d-block mb-2">
                                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_berita)->translatedFormat('d F Y')); ?>

                                </small>
                                <a href="<?php echo e(route('beritashow', $item->slug)); ?>"
...
<div class="col-md-4">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $pengumuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengumuman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-primary text-white">
                <h6 class="card-title fw-semibold mb-0">
                    <i class="bi bi-megaphone-fill me-1"></i> <?php echo e($pengumuman->judul_pengumuman); ?>
            ...
            <div class="card-body">
                ...
                <?php if($pengumuman->file_pengumuman): ?>
                    <?php if(in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                        <div class="mb-3 text-center">
                            <img src="<?php echo e(asset($filePath)); ?>" alt="Lampiran Gambar"
                                class="img-fluid rounded shadow-sm"
                                style="max-width: 75%; height: auto;">
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e(asset($filePath)); ?>" download target="_blank"
                ...
                <div class="mt-1">
                    <small class="text-muted">
                        ...
                        <?php echo e($pengumuman->tanggal_pengumuman
    ...
    <?php $__empty_1 = true; $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="col-md-3 mb-4 animate__animated animate__zoomIn">
        <div class="card h-100 shadow-sm">
          <img src="<?php echo e(asset('storage/' . $foto->foto_kegiatan)); ?>" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Foto">
          <div class="card-body text-center">
            <h6 class="mb-0"><?php echo e($foto->nama_kegiatan ?? 'Kegiatan'); ?></h6>
          </div>
        </div>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('mylayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pkbm-kyag\resources\views/home_index.blade.php ENDPATH**/ ?>